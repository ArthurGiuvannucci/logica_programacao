...
public class Exemplo2 {
    public static void main(String[] args) {
        ...
        /*Se Quantidade de Miojo for menou que 2 ou quatidade de salado maior que 7 "Pouco saudavel"*/
        
        if (quantidadeMiojo<2 || quantidadeSalada>7) {
            System.out.println("Pouco saudavel!");
        }if (quantidadeSalada>= 2 || quantidadeSalada <7){   
        System.out.println("Sudavel!");
        }
    }
}
